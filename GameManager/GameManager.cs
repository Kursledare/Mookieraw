...
namespace GameManager
{
    ...
    {
        public static List<Character> AvailibleTargets => (from gameObject in GameObjects.OfType<ICommandable>() where (gameObject as ICommandable).PlayerControlled == false select gameObject as Character).ToList();

        public static List<Character> Party => (from gameObject in GameObjects.OfType<ICommandable>() where (gameObject as ICommandable).PlayerControlled select gameObject as Character).ToList();
